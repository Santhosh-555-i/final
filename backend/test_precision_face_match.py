...
def run_precision_tests():
    ...
    # API Search via /api/search-face (70% and above matching)
    res = client.post(
        "/api/search-face",
    ...
    assert top_match["similarity"] >= 0.70, f"Top match similarity was below 0.70: {top_match['similarity']}"
    ...
    matches_raw = db_service.match_selfie_vector(event_id, selfie_vec, threshold=0.70)
